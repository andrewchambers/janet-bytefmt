...
(assert (= "10.00TB" (tracev (si-format-byte-size (int/s64 10000000000000)))))
(assert (= "10.00TB" (tracev (si-format-byte-size (int/u64 10000000000000)))))
...
(assert (= "10.00TiB" (tracev (binary-format-byte-size (int/s64 (* 10 1024 1024 1024 1024))))))
(assert (= "10.00TiB" (tracev (binary-format-byte-size (int/u64 (* 10 1024 1024 1024 1024))))))